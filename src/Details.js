  ...
  useEffect(() => {
    const inter = setTimeout(() => {
      switch (data_get?.weather[0]?.main) {
        case "Clear":
          setSrc(
            !(time.hours >= 18 || time.hours < 6)
              ? {
                  vid_link:
                    "https://videos.pexels.com/video-files/11025494/11025494-sd_960_506_30fps.mp4",
                  img_link:
                    "https://assets.msn.com/weathermapdata/1/static/weather/Icons/taskbar_v10/Condition_Card/MostlySunnyDay.svg",
                }
              : {
                  vid_link:
                    "https://videos.pexels.com/video-files/3128132/3128132-sd_640_360_24fps.mp4",
                  img_link:
        ...
        case "Mist":
          setSrc(
            !(time.hours >= 18 || time.hours < 6)
              ? {
                  vid_link:
                    "https://videos.pexels.com/video-files/854691/854691-sd_640_360_30fps.mp4",
                  img_link:
                    "https://assets.msn.com/weathermapdata/1/static/weather/Icons/taskbar_v10/Condition_Card/MostlySunnyDay.svg",
                }
              : {
                  vid_link:
                    "https://videos.pexels.com/video-files/15040626/15040626-sd_640_360_25fps.mp4",
                  img_link:
        ...
        case "Rain":
          setSrc(
            !(time.hours >= 18 || time.hours < 6)
              ? {
                  vid_link:
                    "https://videos.pexels.com/video-files/2491284/2491284-sd_960_506_24fps.mp4",
                  img_link:
                    "https://assets.msn.com/weathermapdata/1/static/weather/Icons/taskbar_v10/Condition_Card/LightRainShowerDay.svg",
                }
              : {
                  vid_link:
                    "https://videos.pexels.com/video-files/7043616/7043616-sd_640_360_25fps.mp4",
                  img_link:
        ...
        case "Clouds":
          setSrc(
            !(time.hours >= 18 || time.hours < 6)
              ? {
                  vid_link:
                    "https://cdn.pixabay.com/video/2017/05/14/9151-217588665_large.mp4",
                  img_link:
                    "https://assets.msn.com/weathermapdata/1/static/weather/Icons/taskbar_v10/Condition_Card/CloudyV3.svg",
                }
              : {
                  vid_link:
                    "https://cdn.pixabay.com/video/2017/08/02/11103-228192366_large.mp4",
                  img_link:
        ...
        case "Haze":
          setSrc(
            !(time.hours >= 18 || time.hours < 6)
              ? {
                  vid_link:
                    "https://videos.pexels.com/video-files/7440470/7440470-sd_640_360_25fps.mp4",
                  img_link:
                    "https://assets.msn.com/weathermapdata/1/static/weather/Icons/taskbar_v10/Condition_Card/D200PartlySunnyV2.svg",
                }
              : {
                  vid_link:
                    "https://videos.pexels.com/video-files/4999944/4999944-sd_640_360_30fps.mp4",
                  img_link:
                    "https://assets.msn.com/weathermapdata/1/static/weather/Icons/taskbar_v10/Condition_Card/MostlyClearNight.svg",
                }
          );
      ...
      <div className="data">
        ...
        <div className="city-heading">
          <header>
            <sub>
              {srcLink.img_link && (
                <img src={srcLink.img_link} alt="Weather-logo" />
              )}
            </sub>
            {data_get?.name}
          </header>
        ...
        <div className="weather-re" ref={tag}>
          <div className="current-weather">
            ...
            <span>
              &nbsp;{time.date}-{time.month}-{time.year}, {days[time.day]}
            </span>
            <br />
          </div>
          <MapComponent
            lon={data_get?.coord?.lon}
            lat={data_get?.coord?.lat}
            className="map"
          />
        </div>
      </div>
